...
namespace OrderFoodOnline.Controllers
{
    namespace OrderFoodOnline.Controllers
    {
        public class ContactUsController : Controller
        {
            ...
            public ContactUsController(OrderFoodOnlineContext context)
            {
                _context = context;
            }
            ...
            public async Task<IActionResult> Create([Bind("Id,Name,Email,Contact,Location,Message")] ContactUs ContactUs)
            {
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Contact,Location,Message")] ContactUs ContactUs)
            {
                if (id != ContactUs.Id)
                {
                    return NotFound();
